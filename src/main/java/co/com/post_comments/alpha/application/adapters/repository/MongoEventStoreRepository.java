...
import co.com.post_comments.alpha.application.adapters.repository.EventDocument;
...
public class MongoEventStoreRepository implements DomainEventRepository {
    ...
    public Mono<DomainEvent> saveEvent(DomainEvent event) {
        ...
        eventStored.setStoredEvent(new EventDocument(aggregateRootId, gson.toJson(event), new Date(), event.getClass().getCanonicalName()));
